...
public class CinemaControllerTest {
    ...
    public void cannotBookTwoTicketsOnSeparateRows(){
        ...
        assertTrue(cinemaController.bookTickets(2));
        assertEquals(cinemaController.getCustomer().getSeats().size(), 2);
        assertTrue(cinemaController.getCinema().getSeats().get(4).isAvailable());
        assertFalse(cinemaController.getCinema().getSeats().get(5).isAvailable());
        assertFalse(cinemaController.getCinema().getSeats().get(6).isAvailable());
    }
    ...
    public void cannotBookWhenLastTwoSeatsSeparatedOnSameRow(){
        ...
        seats.add(new Seat('C', 5, false));
        CinemaController cinemaController = new CinemaController(seats);
        assertFalse(cinemaController.bookTickets(2));
        assertEquals(cinemaController.getCustomer().getSeats().size(), 0);
        assertTrue(cinemaController.getCinema().getSeats().get(1).isAvailable());
        assertTrue(cinemaController.getCinema().getSeats().get(4).isAvailable());
    }
    ...
    public void cannotBookWhenLastTwoSeatsSeparatedOnDifferentRows(){
        ...
        assertEquals(cinemaController.getCustomer().getSeats().size(), 0);
        assertTrue(cinemaController.getCinema().getSeats().get(1).isAvailable());
        assertTrue(cinemaController.getCinema().getSeats().get(12).isAvailable());
    }
}
